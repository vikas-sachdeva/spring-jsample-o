...
public class AppControllerTest {
	...
	@Test
	@WithMockUser(username = AppConstants.UserDetails.USER_ID, password = AppConstants.UserDetails.USER_PASSWORD, roles = AppConstants.Role.USER)
	...
	@Test
	@WithMockUser(username = AppConstants.UserDetails.USER_ID, password = AppConstants.UserDetails.USER_PASSWORD)
	public void getAppsTest2() throws Exception {
	...
	@Test
	@WithMockUser(username = AppConstants.UserDetails.ADMIN_ID, password = AppConstants.UserDetails.ADMIN_PASSWORD, roles = AppConstants.Role.ADMIN)
	...
	@Test
	@WithMockUser(username = AppConstants.UserDetails.USER_ID, password = AppConstants.UserDetails.USER_PASSWORD, roles = AppConstants.Role.USER)
	public void addAppTest2() throws Exception {
		Application app4 = new Application(4, "Application-4", "running");
	...
	@Test
	@WithMockUser(username = AppConstants.UserDetails.USER_ID, password = AppConstants.UserDetails.USER_PASSWORD, roles = AppConstants.Role.USER)
	public void updateAppTest2() throws Exception {
		Application app5 = new Application(5, "Application-5", "running");
	...
	@Test
	@WithMockUser(username = AppConstants.UserDetails.ADMIN_ID, password = AppConstants.UserDetails.ADMIN_PASSWORD, roles = AppConstants.Role.USER)
	public void deleteAppTest3() throws Exception {
	...
	@Test
	@WithMockUser(username = AppConstants.UserDetails.ADMIN_ID, password = AppConstants.UserDetails.ADMIN_PASSWORD)
	public void deleteAppTest4() throws Exception {
