...
public class AppController {
	...
	@GetMapping(value = { AppConstants.URI.GET_APPS_BY_SENSOR_TYPE }, produces = MediaType.APPLICATION_JSON_VALUE)
	@ResponseBody
	public ResponseEntity<?> getAppsBySensorType(@RequestParam(AppConstants.REQ_PARAM.SENSOR_TYPE) Sensor.Type sensorType) {
		return new ResponseEntity<List<Application>>(service.getAppsBySensorType(sensorType),
				HttpStatus.OK);
	}
