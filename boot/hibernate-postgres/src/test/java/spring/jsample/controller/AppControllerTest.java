...
public class AppControllerTest {
	...
	public void updateAppTest1() throws Exception {
		Application app5 = new Application(5L, "Application-5", true);

		Mockito.when(service.updateApp(Mockito.any(Application.class), Mockito.anyLong())).thenReturn(app5);
	...
	public void deleteAppTest1() throws Exception {
		...
		Mockito.doNothing().when(service).deleteApp(Mockito.anyLong());
